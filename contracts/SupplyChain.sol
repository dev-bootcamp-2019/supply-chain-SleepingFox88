...
contract SupplyChain {
    ...
    */
    ...
    modifier verifyCaller (address _address) {require (msg.sender == _address, "msg.sender is not owner of contract"); _;}
    ...
    modifier received(uint _sku) {require(items[_sku].state == State.Received,"Item has not been recieved."); _;}
